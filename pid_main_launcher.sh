...
tmux send-keys "rosrun topic_tools relay /drone${NUMID_DRONE}/mavros/local_position/pose /drone${NUMID_DRONE}/self_localization/pose2" C-m
#tmux send-keys "rosrun topic_tools relay /drone${NUMID_DRONE}/mavros/local_position/pose /drone${NUMID_DRONE}/self_localization/pose2 & \
...
#tmux send-keys "rosrun topic_tools relay /drone${NUMID_DRONE}/mavros/local_position/velocity_local /drone${NUMID_DRONE}/self_localization/speed" C-m
...
tmux send-keys "roslaunch gps_localization gps.launch --wait \
  robot_namespace:=drone$NUMID_DRONE" C-m
